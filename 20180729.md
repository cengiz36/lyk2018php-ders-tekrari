...
<h5>! İnternetten rastgele fotoğraf alıp sitenize ekleyemezsiniz, sonrasında resmin asıl sahibi size dava açabilir. ! </b>
...
front-end tamamen koddan ayrılmış php kdoları tamamen ana kodumuzdan ayrılmış.ÖRneğin css dosyasının içinde php,html kodları yok. MVC şunlar ile yapılabilir; (10.25)
- Larevel
- Cake
- Code ignaither
