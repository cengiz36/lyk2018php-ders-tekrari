...
```php
  <DOCTYPE html> /*hazırladığınız sayfaların hangi tipte bir belge olduğunu tarayıcıya (browser) bildirmek için kullanılır */
  <html lang="tr"> /* Sitenin hangi dillerde aranacağını belirler. */
  <head> /* Bu etiket title (başlık), stiller ve meta bilgileri vb. bulunur. */
    <meta charset="utf-8"> /* Sitenin karakter türünü belirtir */
    <title></title> /* Sitenin başlığını belirler. Facebook a girince sekme de facebook başlığını görmemiz gibi. */
  </head>
